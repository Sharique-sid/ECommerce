            ...
            if (productRepository.count() == 0) {
                List<Product> products = Arrays.asList(
                        createProduct("iPhone 15 Pro Max",
                                ...
                                new BigDecimal("159900"), 50, "Electronics", "Apple",
                                "https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=500", 4.8, 2450),

                        createProduct("Samsung Galaxy S24 Ultra",
                                "Premium Android smartphone with AI features, S Pen, and 200MP camera",
                                new BigDecimal("129999"), 45, "Electronics", "Samsung",
                        ...
                        createProduct("Sony WH-1000XM5",
                                ...
                                new BigDecimal("29990"), 100, "Electronics", "Sony",
                                "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=500", 4.9, 3200),

                        createProduct("MacBook Pro 16-inch M3",
                                "Powerful laptop with M3 Pro chip, stunning Liquid Retina XDR display",
                                new BigDecimal("249900"), 30, "Electronics", "Apple",
                                "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=500", 4.9, 1560),

                        createProduct("Nike Air Max 270",
                                "Comfortable lifestyle sneakers with Max Air unit for all-day cushioning",
                                new BigDecimal("11995"), 200, "Fashion", "Nike",
                                "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500", 4.5, 4500),

                        createProduct("Levi's 501 Original Jeans",
                                "Classic straight fit jeans with authentic vintage style",
                                new BigDecimal("79.99"), 150, "Fashion", "Levi's",
                                "https://images.unsplash.com/photo-1542272604-787c3835535d?w=500", 4.4, 2800),

                        createProduct("Ray-Ban Aviator Classic",
                                "Iconic sunglasses with gold metal frame and green G-15 lenses",
                                new BigDecimal("169.99"), 80, "Accessories", "Ray-Ban",
                                "https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=500", 4.6, 1950),

                        createProduct("Dyson V15 Detect",
                                "Advanced cordless vacuum with laser dust detection technology",
                        ...
                        createProduct("Kindle Paperwhite",
                        ...
                        createProduct("JBL Flip 6",
                                "Portable Bluetooth speaker with powerful sound and IP67 waterproof rating",
                                new BigDecimal("129.99"), 150, "Electronics", "JBL",
                                "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=500", 4.5, 2100),

                        createProduct("Fitbit Charge 6",
                        ...
                        createProduct("The North Face Puffer Jacket",
                                "Warm and lightweight insulated jacket for cold weather",
                                new BigDecimal("249.99"), 60, "Fashion", "The North Face",
                                "https://images.unsplash.com/photo-1544923246-77307dd628b8?w=500", 4.6, 980),

                        createProduct("Philips Hue Starter Kit",
                                "Smart LED bulbs with millions of colors and voice control",
                                new BigDecimal("199.99"), 55, "Home", "Philips",
                                "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500", 4.5, 1420),

                        createProduct("Logitech MX Master 3S",
                        ...
                        createProduct("Bose QuietComfort Earbuds II",
